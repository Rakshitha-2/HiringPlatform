...
const Jobs = () => {
    ...
    return (
        <div className="bg-gradient-to-br from-[#00040A] to-[#001636] min-h-screen">
            {/* Navbar */}
            <Navbar />
            ...
            <div className="max-w-7xl mx-auto pt-24 px-4">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    {/* Mobile Show/Hide Filter Button */}
                    ...
                    <div className="lg:col-span-3">
                        ...
                        >
                            {filteredJobs.length > 0 ? (
                                ...
                                <span className="text-blue-400 font-bold text-lg">No jobs found</span>
                            )}
                        </motion.div>
                    </div>
                </div>
